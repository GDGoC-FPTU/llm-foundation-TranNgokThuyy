...
def compare_models(prompt: str) -> dict:
    ...
    gpt4o_cost = calculate_cost(OPENAI_MODEL, gpt4o_usage)

    mini_cost = calculate_cost(OPENAI_MINI_MODEL, mini_usage)

    gemini_cost = calculate_cost(GEMINI_MODEL, gemini_usage)
